...
function App() {
  ...
  useEffect(() => {
    ...
    if (fileUrl) {
      ...
      // http://localhost:3000/?file=/sample-datasets/barchart.tsv
      (async () => {
  ...
  return (
    <div className="App">
      ...
      <div className="app-sections">
        ...
        <Section title={`Load your data`} loading={loading}>
          <DataLoader {...dataLoader} hydrateFromProject={importProject} />
        </Section>
        {data && (
          
          <Section title="Choose a chart">
        ...
        {data && currentChart && (
          <Section title={`Mapping`} loading={mappingLoading}>
            <DataMapping
              ref={dataMappingRef}
